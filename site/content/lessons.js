export const lessons = {
  ...
  "know-one-thing": { stage: 3, section: "hhh", tab: "head", label: "Know one thing" },
  "statement":      { stage: 3, section: "hhh", tab: "head", label: "Make a statement" },
  "decide":         { stage: 3, section: "hhh", tab: "head", label: "Decide" },
  "prepare":        { stage: 3, section: "hhh", tab: "head", label: "Prepare the mind" },
  "context":        { stage: 3, section: "hhh", tab: "head", label: "Establish the context" },
  "changes":        { stage: 3, section: "hhh", tab: "head", label: "Play the changes" },
  "frame":          { stage: 3, section: "hhh", tab: "head", label: "Draw the frame" },
  "zoom":           { stage: 3, section: "hhh", tab: "head", label: "Zoom in, zoom out" },
  "trust-the-tale": { stage: 3, section: "hhh", tab: "head", label: "Trust the tale" },
  "detail":         { stage: 3, section: "hhh", tab: "head", label: "Attend to detail" },
  "process":        { stage: 3, section: "hhh", tab: "head", label: "Process, not product" },
  "carriage":       { stage: 3, section: "hhh", tab: "hand", label: "Carriage" },
  "touch":          { stage: 3, section: "hhh", tab: "hand", label: "Touch" },
  "tone":           { stage: 3, section: "hhh", tab: "hand", label: "Tone" },
  "intuition":      { stage: 3, section: "hhh", tab: "hand", label: "Intuition" },
  "energy":         { stage: 3, section: "hhh", tab: "hand", label: "Energy" },
  "yin-yang":       { stage: 3, section: "hhh", tab: "hand", label: "Yin-yang" },
  "two-hands":      { stage: 3, section: "hhh", tab: "hand", label: "Two hands as one" },
  "balance":        { stage: 3, section: "hhh", tab: "hand", label: "Balance" },
  "true-self":      { stage: 3, section: "hhh", tab: "heart", label: "True self" },
  "conviction":     { stage: 3, section: "hhh", tab: "heart", label: "Conviction" },
  "jamming":        { stage: 3, section: "hhh", tab: "heart", label: "Jamming" },
  "recording":      { stage: 3, section: "hhh", tab: "heart", label: "Recording" },
  "first-take":     { stage: 3, section: "hhh", tab: "heart", label: "First take" },
  "virtuosity":     { stage: 3, section: "hhh", tab: "heart", label: "Virtuosity" },
  "mastery":        { stage: 3, section: "hhh", tab: "heart", label: "Mastery" },
  // Stage 4
